...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('alumni/kuesioner/simpan') }}">
              {{ csrf_field() }}
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control"  id="{{$kuesioner->id_detail_kuesioner}}" name= "{{$kuesioner->id_detail_kuesioner}}" value="" placeholder="Text Jawaban Singkat" @if($kuesioner->id_jenis == 1) hidden @endif>
