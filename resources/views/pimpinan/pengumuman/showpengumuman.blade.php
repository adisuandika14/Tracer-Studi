                        ...
                        <table class="table table">
                            <td style="width: 50%;">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" style="width: 50%;" id="judul" name= "judul" value="{{$post->judul}}" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label class="font-weight-bold text-dark">Jenis Pengumuman</label>
                                    <input type="text" class="form-control" style="width: 50%;" id="jenis" name= "jenis" value="{{$post->jenis}}" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label class="font-weight-bold text-dark">Perihal Pengumuman</label>
                                    <input type="text" class="form-control" style="width: 50%;" id="perihal" name= "perihal" value="{{$post->perihal}}" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label class="font-weight-bold text-dark">Sifat Surat</label>
                                    <input type="text" class="form-control" style="width: 50%;" id="sifat_surat" name= "sifat_surat" value="{{$post->sifat_surat}}" placeholder="">
                                </div>
                                <div class="form-group" >                                 
                                ...
                                <div class="form-group mt-4 my-2">
                                    <a href="/pimpinan/pengumuman" class="btn btn-secondary btn-icon-split">
