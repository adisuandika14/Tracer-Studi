...
<div style="height: 600px;">
    <div id="fm"></div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
            <form id="form-product" method="post" action="{{url('/admin/lowongan/store')}}" enctype="multipart/form-data">
                @csrf
                <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        <label for="title">Nama Perusahan</label>
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <input type="text" class="form-control" name="jenis_pekerjaan" placeholder="Judul lowongan" required>
                    </div>
                </div>
