...
<div class="container-fluid">
    <h1 class="h3 mb-2 text-gray-800">Profile Pegawai</h1>
    <p class="mb-1">Profile Pegawai Fakultas Teknik Universitas Udayana</p>
    ...
    <div class="row">
        ...
        <div class="col-xl-8 my-auto">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('pegawai-profile-update')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="form-group mt-4">
                            <a href="{{route('pimpinan-home')}}" class="btn btn-danger btn-icon-split">
                                <span class="icon text-white-50">
