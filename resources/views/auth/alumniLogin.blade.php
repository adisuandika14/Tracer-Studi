                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ url('alumni/logins') }}">
                                        @csrf
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control  @error('nim_alumni') is-invalid @enderror" form-control-user
                                                    id="nim_alumni" name="nim_alumni" aria-describedby="emailHelp"
                                                    placeholder="NIM" maxlength="10">
                                                    @error('nim_alumni')
                                                    <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
