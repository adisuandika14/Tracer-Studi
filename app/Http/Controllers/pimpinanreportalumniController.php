...
class pimpinanreportalumniController extends Controller
{
    public function traceralumni(){
        ...
        return view ('/pimpinan/alumni/reportalumni', compact('tracers', 'prodi', 'angkatan','periode', 'kategori_1', 'dataAngkatan', 'dataProdi', 'tahunAngkatan','namaProdi', 'tahun_wisuda', 'tahun_periode'));
    }
